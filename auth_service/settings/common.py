...
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS' : 'core.custom_pagination.StandardResultsSetPagination',
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '30/hour',  # 30 requests per hour for anonymous users
    }
}
...
# Silence Swagger deprecation warning
